...
# Scenario 3: Potential Impossible Travel Detection
## Incident Overview
This scenario documents hands-on detection engineering and investigation of a **Potential Impossible Travel** alert generated by Microsoft Sentinel, leveraging Azure AD sign-in telemetry (`SigninLogs`) to detect suspicious geographic behavior. 
...
### Objective
Detect when a user appears to sign in from geographically disparate locations within a short timeframe — an indicator of potentially compromised credentials or unauthorized access.
...
### Preparation
Incident assigned to SOC Analyst (Myself). Followed NIST SP 800-61 Incident Response Lifecycle.
